...
class NavigationSection extends React.PureComponent<NavigationSectionProps, NavigationSectionState> {
    ...
    render() {
        ...
        const onClickHandler = () => this.setState(prevState => ({ isOpened: !prevState.isOpened }));

        return (
            <div className="styleguide-navigation-section">
                <div
                    className="styleguide-navigation-section__name"
                ...
                >
                    {components ?
                        components.map((link, index) => {
                            ...
                            return (
                                <div
                                    className="styleguide-navigation-section__item"
                                    key={key}
                                >
                                    <a
